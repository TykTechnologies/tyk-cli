...
var rmTemplate string = `Usage:{{if .Runnable}}
  tyk-cli remote rm {alias} {{end}}{{if gt .Aliases 0}}
...
{{rpad .Name (add .NamePadding 5) }} {{.Short}}{{end}}{{end}}{{ end }}{{if .HasAvailableLocalFlags}}
